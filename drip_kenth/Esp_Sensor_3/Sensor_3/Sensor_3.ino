...
void setup() {
  ...
  Firebase.setString(firebaseData,"drip/Sensor_3/wifi_isConnected","true");
  delay(1000);
}
void loop() 
{ 
 ...
 Serial.println("Sensor Status : Dry");
  ...
  Firebase.setString(firebaseData,"drip/Sensor_3/sensor_Status","0"); 
  }
  else if (sensor_Status =="dry"){ 
    Firebase.setString(firebaseData,"drip/Sensor_3/sensor_Status","1");
  }
